...
//
Функция гСформироватьСписокТипов(ДоступныеТипыДанных, СтруктураКЭШ, СписокДобавленныхТипов = Неопределено) Экспорт
	...
	Для каждого ТекущийТип Из ДоступныеТипыДанных Цикл
