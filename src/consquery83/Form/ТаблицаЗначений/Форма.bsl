...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// #рефакторинг прийти к одной переменной ОбъектОбработки() И ОбработкаОбъект
	СписокТипов = ОбъектОбработки().гСформироватьСписокТипов(ОбъектОбработки().Метаданные().Реквизиты.ДоступныеТипыДанных.Тип.Типы());
