...
Функция ВнутрЗначениеОбъектаГраницы()
	ВидГран	= ОбъектОбработки().гОпределениеВидаГраницы(ВидГраницыФормы);
...
Функция РезультатВСтрокуВнутр()
	...
	Возврат ЗначениеВСтрокуВнутр(Новый Граница(ЗначениеИзСтрокиВнутр(Значение), ОбъектОбработки().гОпределениеВидаГраницы(ВидГраницыФормы)));
