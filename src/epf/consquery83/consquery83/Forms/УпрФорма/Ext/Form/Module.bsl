...
Функция ПересохранитьЗначениеВХранилищеТекущейФормы(СтарыйАдресВХранилище)
	...
	Если РезультатЗакрытия <> Неопределено Тогда 
		Если РезультатЗакрытия.ВыбранныеТипы.Количество() > 0 Тогда
			...
			Если ПустаяСтрока(АдресТЗСИнформациейПоТипам) И 
				...
				АдресТЗСИнформациейПоТипам = ПересохранитьЗначениеВХранилищеТекущейФормы(РезультатЗакрытия.АдресТЗСИнформациейПоТипам);					
			КонецЕсли;
