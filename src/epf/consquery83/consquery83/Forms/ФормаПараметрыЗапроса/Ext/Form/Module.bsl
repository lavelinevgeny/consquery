...
Процедура гДобавитьПараметрИзБуфера() Экспорт
	...
	Иначе
		...
		Если лТекстИзБуфера.КоличествоСтрок() = 1 Тогда 
			...
			лСтруктураПараметра = Новый Структура();
			лСтруктураПараметра.Вставить("Имя"     , гПолучитьУникальноеИмяВКоллекции("Параметр", ПараметрыСписок, "Имя"));
			лСтруктураПараметра.Вставить("Тип"     , гТипыЗначенийПараметров().Значение);
		...
		Иначе
			...
			Если лКоличествоКолонок = 1 Тогда 
				...
				лСтруктураПараметра = Новый Структура();
				лСтруктураПараметра.Вставить("Имя"     , гПолучитьУникальноеИмяВКоллекции("Список", ПараметрыСписок, "Имя"));
...
Функция ДобавитьПараметр(СтруктураПараметров)
	...
	Параметр = гНайтиЭлементыКоллекцииПоКлючуБезУчетаРегистра(СтруктураПараметров.Имя, ПараметрыСписок, "Имя", Истина);
