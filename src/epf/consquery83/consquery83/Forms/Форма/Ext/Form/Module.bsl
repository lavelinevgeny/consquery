...
// Инициализация обработки
	...
	ИнициализацироватьСеансовыеДанные(гСеансовыеДанные);
...
Процедура ПриЗакрытии()
	...
	лПутьККартинкам = ЗначениеИзСеансовыхДанных(гСеансовыеДанные, ПоляСеансовыхДанных().ПутьККартинкам);
...
Процедура КнопкаМенюСервисПоискСсылокВСтруктуру(Кнопка)
	...
	Если ЗначениеЗаполнено(лТаблицаНайденныхСсылок) Тогда 
		...
		лИмяПараметра = гПолучитьСледующееУникальноеИмя("НайденныеСсылки", гГлобальныеПеременные);
...
Процедура ПоказатьМенюАвтодополненияТекста(ПолеТекстаЗапроса)
	...
	лПутькКартинке         = ЗначениеИзСеансовыхДанных(гСеансовыеДанные, ПоляСеансовыхДанных().ПутькКартинкам);
...
Процедура ИнициализацироватьСеансовыеДанные(СеансовыеДанные) Экспорт
	
	СеансовыеДанные = Новый Структура();	
	СеансовыеДанные.Вставить("ИдентификаторСеанса", Новый УникальныйИдентификатор);
	СеансовыеДанные.Вставить("ПутьККартинкам"     , ИзвлечьКартинкиОбработкиНаСервере(СеансовыеДанные));
	СеансовыеДанные.Вставить("ДоступныеТипыДанных", Метаданные().Реквизиты.ДоступныеТипыДанных.Тип.Типы());
	
КонецПроцедуры // ИнициализацироватьСеансовыеДанные()

Функция ЗначениеИзСеансовыхДанных(СеансовыеДанные, Имя) Экспорт
...
КонецФункции // ЗначениеИзСеансовыхДанных()

Функция ИзвлечьКартинкиОбработкиНаСервере(СеансовыеДанные)

	лВременныйФайл = Новый Файл(ПолучитьИмяВременногоФайла());
	
	лПутьККартинке = лВременныйФайл.Путь + гПреобразоватьВПравильноеНазвание(гНазваниеОбработки() + "\" + ЗначениеИзСеансовыхДанных(СеансовыеДанные, "ИдентификаторСеанса"), "\");
