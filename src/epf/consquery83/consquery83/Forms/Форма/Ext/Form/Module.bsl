...
// Инициализация обработки
	...
	гИнициализацироватьСеансовыеДанные(гСеансовыеДанные);
...
Процедура ПриЗакрытии()
	...
	лПутьККартинкам = гЗначениеИзСеансовыхДанных(гСеансовыеДанные, ПоляСеансовыхДанных().ПутьККартинкам);
...
Процедура ПоказатьМенюАвтодополненияТекста(ПолеТекстаЗапроса)
	...
	лПутькКартинке         = гЗначениеИзСеансовыхДанных(гСеансовыеДанные, ПоляСеансовыхДанных().ПутькКартинкам);
			...
			Для Каждого ТЧ ИЗ СтрокаТаблицы.Метаданные.ТабличныеЧасти Цикл
				Для Каждого Реквизит Из ТЧ.Реквизиты Цикл
					Если Реквизит.Тип.СодержитТип(ТипЗнч(Ссылка)) Тогда
						...
						СтрокиТабЧасти = ОбъектТЧ.НайтиСтроки(Новый Структура(Реквизит.Имя, Ссылка));						
