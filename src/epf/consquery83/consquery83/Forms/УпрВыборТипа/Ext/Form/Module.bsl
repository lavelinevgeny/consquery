...
// 
&НаСервереБезКонтекста
Функция ОбъектОбработкиМенеджер()
...
Процедура ОбновитьСписокТипов()
	...
	Если Не ЗначениеЗаполнено(АдресТЗСИнформациейПоТипам) Тогда 
		...
		Если Не ОбъектОбработкиМенеджер().СформироватьТаблицуСТипами(АдресТЗСИнформациейПоТипам, УникальныйИдентификатор, Ошибки, СеансовыеДанные) Тогда 
